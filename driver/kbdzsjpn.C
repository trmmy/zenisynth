...
*
* History:
* KBDTOOL v3.40 - Created  Sun Jan 11 19:21:24 2009
\***************************************************************************/
...
extern __declspec(dllexport) PKBDTABLES KbdLayerDescriptor(VOID)
{
    return &KbdTables;
}
